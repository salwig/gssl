...
from .MFAGL import MFAGL as MFAGLdense
from .MFAGLsparse import MFAGLsparse
...
class MFAGL(Gaussian):
    ...
    def __init__(
        ...
        self.GLdense = MFAGLdense(C=C, D=D)
        self.GLsparse = MFAGLsparse(C=C, D=D)
    ...
    def predict(
        ...
        with Timer(self.GL.time, "time_predict"):
            predicted_labels = self.GL._compute_labels(class_norm=class_norm)
